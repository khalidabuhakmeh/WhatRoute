...
A simple set of extension methods to help you figure out whether you are on a particular route or not.

Available via "NuGet":http://nuget.org/List/Packages/WhatRoute

<pre><code> PM> Install-Package WhatRoute.Core </code></pre>
...
Html.IsActiveCss(string action, string controller, string area = "", cssClass = "active")
...
Written by "Khalid Abuhakme":http://github.com/khalidabuhakmeh
